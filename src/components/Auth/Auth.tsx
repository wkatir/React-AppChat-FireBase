  ...
  return (
    ...
    <div className="relative w-full max-w-xl">
      ...
      <div className="relative px-6 py-8 sm:px-8 bg-gray-900/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-700">
        <div className="flex items-center justify-center space-x-2 mb-4 px-2"> {/* Cambié mb-8 a mb-4 */}
        ...
        <div className="w-full sm:max-w-md mx-auto">
          <button
            ...
            className="group relative w-full overflow-hidden rounded-lg p-px mt-4 focus:outline-none" 
          >
