...
const Auth: React.FC<AuthProps> = (props) => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 px-4 sm:px-6">
      <div className="relative w-full max-w-sm sm:max-w-xl">
        ...
        {/* Main Card */}
        <div className="relative px-4 py-6 sm:px-8 sm:py-8 bg-gray-900/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-700">
          {/* Title Section */}
          <div className="flex items-center justify-center space-x-2 mb-4 px-2">
            ...
            <h1 className="text-xl sm:text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400 pb-1 text-center">
              Kodigo Chat
            </h1>
          ...
          <div className="w-full sm:max-w-md mx-auto">
            <button
              ...
              className="group relative w-full overflow-hidden rounded-lg p-px mt-2 sm:mt-4 focus:outline-none"
            >
              <span className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite] bg-gradient-to-r from-blue-500 to-purple-600" />
              <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-lg bg-gray-900 px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base font-medium backdrop-blur-3xl transition-all duration-300 group-hover:bg-opacity-80">
                <span className="relative text-gray-100 flex items-center gap-2 sm:gap-3 font-semibold">
                  <svg
